...
-- Teleporting button for "totem Aurora"
Teleporting:AddButton({
    Title = "totem Aurora",
    Callback = function()
...
-- Teleporting button for "totem Sundial"
Teleporting:AddButton({
    Title = "totem Sundial",
    Callback = function()
...
-- Teleporting button for "totem Windset"
Teleporting:AddButton({
    Title = "totem Windset",
    Callback = function()
...
-- Teleporting button for "totem Smokescreen"
Teleporting:AddButton({
    Title = "totem Smokescreen",
    Callback = function()
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(2789, 140, -625)
    end
})

-- Teleporting button for "totem Tempest"
Teleporting:AddButton({
    Title = "totem Tempest",
    Callback = function()
...
-- Teleporting button for "totem Eclipse"
Teleporting:AddButton({
    Title = "totem Eclipse",
    Callback = function()
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(5968, 273.9, 838)
    end
})

-- Teleporting button for "totem Meteor"
Teleporting:AddButton({
    Title = "totem Meteor",
    Callback = function()
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-1948, 275.4, 230)
    end
})

-- Teleporting button for "totem blizade"
Teleporting:AddButton({
    Title = "totem blizade",
    Callback = function()
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(20145, 743, 5805)
    end
})

-- Teleporting button for "totem avalache"
Teleporting:AddButton({
    Title = "totem avalache",
    Callback = function()
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(19710.8, 467.6, 6052.3)
})
